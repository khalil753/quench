...
const experiment_name = "large_chi_limit"
...
const σ = 1.0
const switching_function_center_A = 0.6σ
const switching_function_center_B = 0.6σ

# Quench regulator
const b = 1e-1

# Detector frequencies and Initial positions
nΩ = 15 # Number of frquencies/initial conditions to iterate over
nχ = 15
const χ0A = 20σ 
